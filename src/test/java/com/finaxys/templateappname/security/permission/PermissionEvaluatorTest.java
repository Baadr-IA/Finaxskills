...
class PermissionEvaluatorTest {
    ...
    private final PermissionProfileRepository repository = () -> Map.of(
        "self_profile", new PermissionProfile(
            "self_profile",
            "Self Profile",
            List.of(new PermissionGrant(ResourceKey.GREETINGS, Set.of(Action.READ), Scope.SELF))
        ),
        "team_profile", new PermissionProfile(
            "team_profile",
            "Team Profile",
            List.of(new PermissionGrant(ResourceKey.GREETINGS, Set.of(Action.CREATE), Scope.TEAM))
        ),
        "org_profile", new PermissionProfile(
            "org_profile",
            "Org Profile",
            List.of(new PermissionGrant(ResourceKey.GREETINGS, Set.of(Action.UPDATE), Scope.ORG))
        ),
        "all_profile", new PermissionProfile(
            "all_profile",
            "All Profile",
            List.of(new PermissionGrant(ResourceKey.GREETINGS, Set.of(Action.DELETE), Scope.ALL))
        )
    );
